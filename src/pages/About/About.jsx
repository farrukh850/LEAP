  ...
  return (
    <>
      ...
      <div className="py-20 max-xl:px-5 max-lg:py-10">
        <div className="container">
          <div className="flex items-center gap-2">
            <h2 className="text-3xl max-lg:text-xl inline-block font-poppins font-bold relative">MISSION <b className="text-[#FF395B]">STATEMENT</b><span className="absolute -bottom-2 right-0 left-0 h-[3px] w-[75%] bg-[#101010]
          ...
          <div className="flex items-stretch max-lg:flex-col max-lg:gap-16 gap-3 mt-25">
            <div className="bg-white border-[0.5] border-black/10 rounded-xl p-7 pt-12 shadow-[0px_1px_14px_0px_rgba(0,0,0,0.06)] relative">
              <span className="px-5 py-2 text-2xl text-white absolute -top-[25px] left-7 font-bold font-poppins  rounded-lg bg-[#008000]">Mission</span>
            ...
            <div className="bg-white border-[0.5] border-black/10 rounded-xl p-7 pt-12 shadow-[0px_1px_14px_0px_rgba(0,0,0,0.06)] relative">
              <span className="px-5 py-2 text-2xl text-white absolute -top-[25px] left-7 font-bold font-poppins  rounded-lg bg-[#008000]">Vision</span>
      ...
      <div className="py-10 max-xl:px-5">
        <div className="container">
          <h2 className="text-3xl inline-block font-poppins font-bold relative">Team <b className="text-[#FF395B]">members.</b><span className="absolute -bottom-2 right-0 left-0 h-[3px] w-[75%] bg-[#101010]"></span></h2>
            ...
            <div className="col-span-3 max-lg:col-span-6 relative text-center">
             <div className="relative">
              <img src="/images/team-member-1.png" className="mx-auto" alt="Team Member Image" />
                <a href="#" className="absolute left-1/2 -translate-x-1/2 -bottom-[15px] bg-[#008000] w-[51px] h-[51px] rounded-[10px] flex items-center justify-center">
