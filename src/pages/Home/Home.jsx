    ...
    <>
      <div className="relative xl:h-screen">
        <div className="container max-xl:px-5">
          <div className="flex flex-col max-md:flex-col gap-7 lg:w-[50%] max-lg:pt-32 lg:h-screen justify-center">
            <h1 className="text-6xl max-lg:text-4xl text-black font-bold font-poppins">Potential has no <b className="text-[#FF395B]">Boarders</b></h1>
      ...
      <div className="container py-28 max-xl:px-5 max-sm:pb-10">
        <div className="flex justify-between items-center">
          <h2 className="text-3xl max-lg:text-xl uppercase font-poppins font-bold relative">Our <b className="text-[#FF395B]">Services</b><span className="absolute -bottom-2 right-0 left-0 h-[3px] bg-[#101010]
          "></span></h2>
            <Button />
        </div>
        <div className="grid grid-cols-12 mt-40 gap-5 max-xl:space-y-16 items-stretch">
          <div className="col-span-3 max-md:col-span-12 max-xl:col-span-6 p-6 border border-[#0000001A]/10 bg-white pt-16 shadow-[0px_1px_14px_0px_rgba(0,0,0,0.1)] rounded-xl relative">
            <div className="w-25 h-25 rounded-xl bg-[#008000] flex items-center justify-center mx-auto absolute -top-[20%] left-1/2 -translate-x-1/2">
              <img src="/images/service-icon1.svg" alt="Service Icon" />
            </div>
            <h3 className="text-xl font-semibold font-poppins text-[#008000] my-4 text-center">Corporate & University Consulting</h3>
          ...
          <div className="col-span-3 max-md:col-span-12 max-xl:col-span-6 p-6 border border-[#0000001A]/10 bg-white pt-16 shadow-[0px_1px_14px_0px_rgba(0,0,0,0.1)] rounded-xl relative">
            ...
            <h3 className="text-xl font-semibold font-poppins text-[#008000] my-4 text-center">Program Curriculum Development</h3>
          ...
          <div className="col-span-3 max-md:col-span-12 max-xl:col-span-6 p-6 border border-[#0000001A]/10 bg-white pt-16 shadow-[0px_1px_14px_0px_rgba(0,0,0,0.1)] rounded-xl relative">
            ...
            <h3 className="text-xl font-semibold font-poppins text-[#008000] my-4 text-center">Workplace Inclusion 
            Strategies</h3>
          ...
          <div className="col-span-3 max-md:col-span-12 max-xl:col-span-6 p-6 border border-[#0000001A]/10 bg-white pt-16 shadow-[0px_1px_14px_0px_rgba(0,0,0,0.1)] rounded-xl relative">
            ...
            <h3 className="text-xl font-semibold font-poppins text-[#008000] my-4 text-center">Educational Training & Workshops</h3>
      ...
      <div className="container pb-28 max-xl:px-5 max-sm:pb-10">
          <div className="flex justify-between items-center">
            <h2 className="text-3xl max-lg:text-xl uppercase font-poppins font-bold relative">Countries <b className="text-[#FF395B]">where we have worked</b><span className="absolute -bottom-2 right-0 left-0 h-[3px] bg-[#101010]
            "></span></h2>
          </div>
          <img src="/images/map.svg" className="mt-24" alt="Map" />
      </div>
      <div className="py-22 bg-[#008000] max-sm:py-10">
        <div className="container max-xl:px-5">
      ...
      <div className="py-25 bg-[#F8F8F8] max-xl:px-5 max-sm:pb-10">
        <div className="container flex max-md:flex-col items-center gap-12">
          <div className="flex flex-col flex-1 gap-9 items-start">
            <h2 className="text-3xl inline-block font-poppins font-bold relative">Success <b className="text-[#FF395B]">Stories</b><span className="absolute -bottom-2 right-0 left-0 h-[3px] w-[75%] bg-[#101010]
            "></span></h2>
            ...
            <Link href="#" className="py-2.5 px-9 bg-[#008000] text-base font-medium text-white font-poppins rounded-lg">Explore Our Stories</Link>
          </div>
